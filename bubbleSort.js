...
// Optimized with a noSwaps variable to make it stop sorting as soon as it sorts (makes much faster for nearly sorted data)
// O(N^2) time bc of nested loop, but in the best case it can be close to O(N) but that doesn't matter.
// O(1) space, just letting a few variables like i, j, noSwaps, and temp.
